...
const recentClients = [
  { id: 1, name: "Lucas Oliveira", initials: "LO", date: "15/03/2025" },
  { id: 2, name: "Marcos Santos", initials: "MS", date: "20/03/2025" },
  { id: 3, name: "Pedro Henrique", initials: "PH", date: "01/04/2025" },
  { id: 4, name: "Rafael Costa", initials: "RC", date: "05/04/2025" },
];
            ...
            {todayAppointments.length === 0 ? (
              ...
              todayAppointments.map((appt) => (
                <div key={appt.id} className="flex items-center gap-4 px-5 py-4">
                  <div className={`w-9 h-9 ${getInitialsColor(appt.initials)} rounded-full flex items-center justify-center shrink-0`}>
                    <span className="text-white text-xs font-semibold">{appt.initials}</span>
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-white">{appt.client}</p>
                    <p className="text-xs text-zinc-500 mt-0.5">
                      {appt.service} • {appt.professional}
                    </p>
                  </div>
                  <div className="flex items-center gap-3 shrink-0">
                    <span className="text-sm font-medium text-zinc-300">{appt.time}</span>
